...
class AccountingState extends State<Accounting> {
  ...
  Future accounts_payment() async {
    var url = Uri.http("192.168.87.161",'StudentDB/accounts_payment.php', {'q': '{http}'});
  ...
  Future clearance_fee() async {
    var url = Uri.http("192.168.87.161",'StudentDB/clearance_fee.php', {'q': '{http}'});
    var response = await http.post(url, body: {
      "id": id,
    });
    var check = json.decode(response.body);
  ...
  Future enrolment_fee() async {
    var url = Uri.http("192.168.87.161",'StudentDB/enrolment_fee.php', {'q': '{http}'});
    var response = await http.post(url, body: {
      "id": id,
    });
    var check = json.decode(response.body);
  ...
  Future renewal_fee() async {
    var url = Uri.http("192.168.87.161",'StudentDB/renewal_fee.php', {'q': '{http}'});
    var response = await http.post(url, body: {
      "id": id,
    });
    var check = json.decode(response.body);
  ...
  Future graduation_fee() async {
    var url = Uri.http("192.168.87.161",'StudentDB/graduation_fee.php', {'q': '{http}'});
    var response = await http.post(url, body: {
      "id": id,
    });
    var check = json.decode(response.body);
                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      CircleAvatar(
                        radius: 50.0,
                        backgroundColor: Colors.white,//jm
