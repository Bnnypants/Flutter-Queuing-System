...
class RegistrarState extends State<Registrar> {
  ...
  Future clearance_signing() async {
    var url = Uri.http("192.168.87.161",'StudentDB/clearance_signing.php', {'q': '{http}'});
  ...
  Future claim_permit() async {
    var url = Uri.http("192.168.87.161",'StudentDB/claim_permit.php', {'q': '{http}'});
    var response = await http.post(url, body: {
      "id": id,
    });
    var check = json.decode(response.body);
  ...
  Future claim_grades() async {
    var url = Uri.http("192.168.87.161",'StudentDB/claim_grades.php', {'q': '{http}'});
    var response = await http.post(url, body: {
      "id": id,
    });
    var check = json.decode(response.body);
  ...
  Future claim_documents() async {
    var url = Uri.http("192.168.87.161",'StudentDB/claim_documents.php', {'q': '{http}'});
    var response = await http.post(url, body: {
      "id": id,
    });
    var check = json.decode(response.body);
